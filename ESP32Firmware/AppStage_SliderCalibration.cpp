...
void AppStage_SliderCalibration::exit()
{
    ...
    WebSocketManager::getInstance()->clearCommandHandler(this);
}

// WSCommandHandler Events
bool AppStage_SliderCalibration::onCommand(const std::vector<std::string>& args, WSCommandResponse& results)
{
    if (args[0] == "stop")
    {
...
void AppStage_SliderCalibration::onEnterState(eSliderCalibrationState newState)
{
    ...
    case eSliderCalibrationState::Setup:
        {
            wsManager->setStatus("calibration_started");
    ...
    case eSliderCalibrationState::FindTiltCenter:
        ...
        break;
    case eSliderCalibrationState::Complete:
        wsManager->setStatus("calibration_completed");
        m_activeMenu = &m_completeMenu;
        break;
    case eSliderCalibrationState::Failed:
        wsManager->setStatus("calibration_failed");
